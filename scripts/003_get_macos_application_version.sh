APPLICATION_NAME="Google Chrome" # since the application name is stored in a string, you do NOT need to escape spaces as you would if you were running the following line directly from terminal
